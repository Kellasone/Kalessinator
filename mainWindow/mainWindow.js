...
mainWindow.classList.add('window-box');
mainWindow.style.width='400px';
mainWindow.style.height='700px';

const windowTitle = document.createElement('div');
windowTitle.classList.add('window-box-title');
...
document.querySelector('body').appendChild(mainWindow);

dragElement(document.getElementsByClassName("window-box")[0]);

function dragElement(elmnt) {
    var pos1 = 0, pos2 = 0, pos3 = 0, pos4 = 0;

    document.getElementsByClassName("window-box-title")[0].onmousedown = dragMouseDown;
